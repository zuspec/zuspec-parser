...
/* Root component: wb_dma_c; link-style: direct. */
/* ABI-affecting settings: addr-bits=64, lifecycle=static, reg-style=bitfields, mem-access=functions, struct-args=value */
