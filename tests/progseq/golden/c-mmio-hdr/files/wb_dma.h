...
/* Root component: wb_dma_c; link-style: mmio. */
/* ABI-affecting settings: addr-bits=64, lifecycle=malloc, reg-style=bitfields, mem-access=from-link-style, struct-args=value */
...
typedef union { uint32_t raw; struct {
    uint32_t ch_en        :  1;   /* [0] sw=rw hw=r reset=0x0 */
    uint32_t dst_sel      :  1;   /* [1] sw=rw hw=r reset=0x0 */
    uint32_t src_sel      :  1;   /* [2] sw=rw hw=r reset=0x0 */
    uint32_t inc_dst      :  1;   /* [3] sw=rw hw=r reset=0x0 */
    uint32_t inc_src      :  1;   /* [4] sw=rw hw=r reset=0x0 */
    uint32_t mode         :  1;   /* [5] sw=rw hw=r reset=0x0 */
    uint32_t ars          :  1;   /* [6] sw=rw hw=r reset=0x0 */
    uint32_t use_ed       :  1;   /* [7] sw=rw hw=r reset=0x0 */
    uint32_t sz_wb        :  1;   /* [8] sw=rw hw=r reset=0x0 */
    uint32_t stop         :  1;   /* [9] sw=w hw=r reset=0x0 */
    uint32_t busy         :  1;   /* [10] sw=r hw=w */
    uint32_t done         :  1;   /* [11] sw=r hw=w */
    uint32_t err          :  1;   /* [12] sw=r hw=w */
    uint32_t prio         :  3;   /* [15:13] sw=rw hw=r reset=0x0 */
    uint32_t rest_en      :  1;   /* [16] sw=rw hw=r reset=0x0 */
    uint32_t ine_err      :  1;   /* [17] sw=rw hw=r reset=0x0 */
    uint32_t ine_done     :  1;   /* [18] sw=rw hw=r reset=0x0 */
    uint32_t ine_chk_done :  1;   /* [19] sw=rw hw=r reset=0x0 */
    uint32_t int_err      :  1;   /* [20] sw=r hw=w reset=0x0 dropped: onread=rclr, intr, enable */
