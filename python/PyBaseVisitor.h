...
private:
    ...
    virtual void visitState(IState *i) override;
    void py_visitState(IState *i);
    virtual void visitStream(IStream *i) override;
    void py_visitStream(IStream *i);
    virtual void visitBuffer(IBuffer *i) override;
    void py_visitBuffer(IBuffer *i);
    virtual void visitResource(IResource *i) override;
