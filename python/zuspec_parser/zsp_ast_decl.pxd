...
cdef extern from "zsp/ast/ExprBinOp.h" namespace "zsp::ast":
    cdef enum ExprBinOp:
        BinOp_LogOr "zsp::ast::ExprBinOp::BinOp_LogOr"
        BinOp_LogAnd "zsp::ast::ExprBinOp::BinOp_LogAnd"
        BinOp_BitOr "zsp::ast::ExprBinOp::BinOp_BitOr"
        BinOp_BitXor "zsp::ast::ExprBinOp::BinOp_BitXor"
        BinOp_BitAnd "zsp::ast::ExprBinOp::BinOp_BitAnd"
        BinOp_Lt "zsp::ast::ExprBinOp::BinOp_Lt"
        BinOp_Le "zsp::ast::ExprBinOp::BinOp_Le"
        BinOp_Gt "zsp::ast::ExprBinOp::BinOp_Gt"
        BinOp_Ge "zsp::ast::ExprBinOp::BinOp_Ge"
        BinOp_Exp "zsp::ast::ExprBinOp::BinOp_Exp"
        BinOp_Mul "zsp::ast::ExprBinOp::BinOp_Mul"
        BinOp_Div "zsp::ast::ExprBinOp::BinOp_Div"
        BinOp_Mod "zsp::ast::ExprBinOp::BinOp_Mod"
        BinOp_Add "zsp::ast::ExprBinOp::BinOp_Add"
        BinOp_Sub "zsp::ast::ExprBinOp::BinOp_Sub"
        BinOp_Shl "zsp::ast::ExprBinOp::BinOp_Shl"
        BinOp_Shr "zsp::ast::ExprBinOp::BinOp_Shr"
        BinOp_Eq "zsp::ast::ExprBinOp::BinOp_Eq"
        BinOp_Ne "zsp::ast::ExprBinOp::BinOp_Ne"
cdef extern from "zsp/ast/ExprUnaryOp.h" namespace "zsp::ast":
    cdef enum ExprUnaryOp:
        UnaryOp_Plus "zsp::ast::ExprUnaryOp::UnaryOp_Plus"
        UnaryOp_Minus "zsp::ast::ExprUnaryOp::UnaryOp_Minus"
        UnaryOp_LogNot "zsp::ast::ExprUnaryOp::UnaryOp_LogNot"
        UnaryOp_BitNeg "zsp::ast::ExprUnaryOp::UnaryOp_BitNeg"
        UnaryOp_BitAnd "zsp::ast::ExprUnaryOp::UnaryOp_BitAnd"
        UnaryOp_BitOr "zsp::ast::ExprUnaryOp::UnaryOp_BitOr"
        UnaryOp_BitXor "zsp::ast::ExprUnaryOp::UnaryOp_BitXor"
cdef extern from "zsp/ast/ExtendTargetE.h" namespace "zsp::ast":
    cdef enum ExtendTargetE:
        Action "zsp::ast::ExtendTargetE::Action"
        Buffer "zsp::ast::ExtendTargetE::Buffer"
        Component "zsp::ast::ExtendTargetE::Component"
        Enum "zsp::ast::ExtendTargetE::Enum"
        Resource "zsp::ast::ExtendTargetE::Resource"
        State "zsp::ast::ExtendTargetE::State"
        Stream "zsp::ast::ExtendTargetE::Stream"
        Struct "zsp::ast::ExtendTargetE::Struct"
cdef extern from "zsp/ast/StructKind.h" namespace "zsp::ast":
    cdef enum StructKind:
        Buffer "zsp::ast::StructKind::Buffer"
        Struct "zsp::ast::StructKind::Struct"
        Resource "zsp::ast::StructKind::Resource"
        Stream "zsp::ast::StructKind::Stream"
        State "zsp::ast::StructKind::State"
cdef extern from "zsp/ast/TypeCategory.h" namespace "zsp::ast":
    cdef enum TypeCategory:
        Action "zsp::ast::TypeCategory::Action"
        Component "zsp::ast::TypeCategory::Component"
        Buffer "zsp::ast::TypeCategory::Buffer"
        Resource "zsp::ast::TypeCategory::Resource"
        State "zsp::ast::TypeCategory::State"
        Stream "zsp::ast::TypeCategory::Stream"
cdef extern from "zsp/ast/FieldAttr.h" namespace "zsp::ast":
    cdef enum FieldAttr:
        A "zsp::ast::FieldAttr::A"
        B "zsp::ast::FieldAttr::B"
        R "zsp::ast::FieldAttr::R"
        C "zsp::ast::FieldAttr::C"
        S "zsp::ast::FieldAttr::S"
        P "zsp::ast::FieldAttr::P"
        P "zsp::ast::FieldAttr::P"
